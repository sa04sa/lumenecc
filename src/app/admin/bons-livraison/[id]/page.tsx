...
export default async function EditBonLivraisonPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-900">
          {facture.statut === 'validee' ? 'Consulter le Bon de Livraison' : 'Modifier le Brouillon'}
        </h1>
