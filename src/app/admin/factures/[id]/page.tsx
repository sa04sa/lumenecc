import { getClients, getParametres, getFactureById, getFactureLignes, getDocumentChildren } from "../../actions";
import InvoiceForm from "../nouvelle/InvoiceForm";
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-900">
          {facture.statut === 'validee' ? 'Consulter la Facture' : 'Modifier le Brouillon'}
        </h1>
